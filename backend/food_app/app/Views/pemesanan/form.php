            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="control-label col-md-3">Status Pemesanan</div>
                        <div class="col-md-8">
                            <?php
                            $dropdown = field_enums('pemesanan', 'status_pemesanan', 'Pilih Status');
                            echo form_dropdown('status_pemesanan', $dropdown, '', 'class="form-control" id="status_pemesanan"');
                            ?>
