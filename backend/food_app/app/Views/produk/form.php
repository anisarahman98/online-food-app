        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="control-label col-md-3">Harga Produk</div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="control-label col-md-3">Kategori Produk</div>
                        <div class="col-md-8">
                            <?php
                            $dropdown = getDropdownList('kategori', ['nama_kategori', 'nama_kategori'], 'Kategori Produk');
                            echo
                            form_dropdown('kategori', $dropdown, '', 'class="form-control"');
                            ?>
                            <span class="help-block"></span>
                        </div>
                        <div class="col-md-1"></div>
                    ...
                    <div class="form-group">
                        <div class="control-label col-md-3">Deskripsi Produk</div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="control-label col-md-3">Gambar Produk</div>
                        <div class="col-md-8">
