...
import 'package:online_food_app/src/ui/main/Register.dart';
import 'package:online_food_app/src/ui/main/forgotpssword/CekEmail.dart';
...
class _LoginState extends State<Login> {
  ...
  _login() async {
    ...
    if (status) {
      print(message);
      ShowToast().showToastSuccess('Login Berhasil !');
      ...
      ShowToast()
          .showToastError('Email atau Password salah!, silahkan coba kembali');
    }
  }
}
