...
import 'package:online_food_app/src/bloc/AuthBloc.dart';
...
class _RegisterState extends State<Register> {
  ...
  bool isValidNoTlp = false;
  bool isValidEmail = false;
  bool isValidPassword = false;
  String isValidNamaText = 'nama harus di isi';
  String isValidNoTlpText = 'masukkan no telepon/hp';
  String isValidEmailText = 'email harus di isi';
  String isValidPasswordText = 'password harus di isi';
            ...
            children: [
              Expanded(
                child: TextFormField(
                  ...
                  maxLengthEnforced: true,
                  validator: (value) {
                    return !isValidNoTlp ? isValidNoTlpText : null;
                  },
                ),
              ),
            ],
  ...
  validateNoTlp(StateSetter updateState) async {
    if (_noTlpController.text.length >= 10) {
      updateState(() {
        isValidNoTlp = true;
      });
    } else if (_noTlpController.text.length <= 10) {
      updateState(() {
        isValidNoTlp = false;
        isValidNoTlpText = 'min. 10 angka';
      });
    }
  }
  ...
  _register() async {
    ...
    if (status) {
      print(message);
       ShowToast().showToastSuccess('Registrasi Berhasil !');
